...
public class UpdatePlan extends LogicalPlan {
    ...
    final static String errColumnName = "Exception: wrong update operation ( no such column )!";
    final static String errColumnType = "Exception: wrong update operation ( type unmatched )!";
    final static String duplicateKey = "Exception: wrong update operation ( update causes duplicate key )!";
    final static String errStringLength = "Exception: wrong update operation ( update causes string exceeds length limit )!";

    public UpdatePlan(String tableName, String columnNmae, String attrValue, SQLParser.MultipleConditionContext mc) {
    ...
    public void exec() {
        ...
        if (attrValue == null && columnToUpdate.isNotNull()) {
                throw new InsertErrorException(
                        "Exception:  insert operation error ( " + columnToUpdate.getColumnName() + " cannot be null)");
        }
        else{
